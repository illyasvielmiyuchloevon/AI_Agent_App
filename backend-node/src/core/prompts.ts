...
export const MODE_PROMPTS: Record<string, string> = {
    ...
    canva:
        "You are in CANVA mode: a hands-on frontend/full-stack builder. " +
        ...
        TOOL_GUIDANCE,
    agent:
        "You are in AGENT mode: full autonomy with all tools (files, shell, desktop). " +
...
export function updatePrompt(mode: string, prompt: string) {
