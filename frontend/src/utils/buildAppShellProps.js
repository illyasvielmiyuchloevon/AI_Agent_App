export function buildAppShellProps({ workspace = {}, sessions = {}, git = {}, layout = {}, prefs = {} } = {}) {
  return {
    ...
    showConfig: workspace.showConfig ?? prefs.showConfig,
    setShowConfig: workspace.setShowConfig ?? prefs.setShowConfig,
    config: workspace.config ?? prefs.config,
    setConfig: workspace.setConfig ?? prefs.setConfig,
    toolSettings: workspace.toolSettings ?? prefs.toolSettings,
    persistToolSettings: workspace.persistToolSettings ?? prefs.persistToolSettings,
    handleConfigSubmit: workspace.handleConfigSubmit ?? prefs.handleConfigSubmit,
    setConfigFullscreen: workspace.setConfigFullscreen ?? prefs.setConfigFullscreen,
    configFullscreen: workspace.configFullscreen ?? prefs.configFullscreen,
    checkApiStatus: workspace.checkApiStatus ?? prefs.checkApiStatus,
    apiStatus: workspace.apiStatus ?? prefs.apiStatus,
    apiMessage: workspace.apiMessage ?? prefs.apiMessage,
    userThemePreferenceRef: prefs.userThemePreferenceRef ?? workspace.userThemePreferenceRef,
    ...
    handleOpenConfigInEditor: workspace.handleOpenConfigInEditor ?? prefs.handleOpenConfigInEditor,
    projectConfig: workspace.projectConfig ?? prefs.projectConfig,
    setProjectConfig: workspace.setProjectConfig ?? prefs.setProjectConfig,
    showCommandPalette: workspace.showCommandPalette ?? prefs.showCommandPalette,
    closeCommandPalette: workspace.closeCommandPalette ?? prefs.closeCommandPalette,
    commandPaletteInitialQuery: workspace.commandPaletteInitialQuery ?? prefs.commandPaletteInitialQuery,
    commandPaletteContext: workspace.commandPaletteContext ?? prefs.commandPaletteContext,
    workspaceProps: workspace.workspaceProps,
    openFile: workspace.openFile,
    closeFile: workspace.closeFile,
    setGlobalSearchQuery: workspace.setGlobalSearchQuery ?? prefs.setGlobalSearchQuery,
    handleSidebarTabChange: layout.handleSidebarTabChange,
    lspService: workspace.lspService,
    editorAiInvoker: workspace.editorAiInvoker ?? prefs.editorAiInvoker,
    ...
    handleOpenDiff: workspace.handleOpenDiff ?? prefs.handleOpenDiff,
    ...
    globalSearchQuery: workspace.globalSearchQuery ?? prefs.globalSearchQuery,
    ...
    diffModal: workspace.diffModal ?? prefs.diffModal,
    closeDiffModal: workspace.closeDiffModal ?? prefs.closeDiffModal,
    handleOpenDiffInWorkspace: workspace.handleOpenDiffInWorkspace ?? prefs.handleOpenDiffInWorkspace,
    logs: sessions.logs,
    ...
    showRemoteModal: workspace.showRemoteModal ?? prefs.showRemoteModal,
    handleConnectRemote: workspace.handleConnectRemote ?? prefs.handleConnectRemote,
    showCloneModal: workspace.showCloneModal ?? prefs.showCloneModal,
    ...
    setEditorAiInvoker: workspace.setEditorAiInvoker ?? prefs.setEditorAiInvoker,
    undoRedoLimit: workspace.undoRedoLimit ?? prefs.undoRedoLimit,
    changeEditorNavigationMode: workspace.changeEditorNavigationMode ?? prefs.changeEditorNavigationMode,
    ...
    inputModal: workspace.inputModal ?? prefs.inputModal,
  };
}
